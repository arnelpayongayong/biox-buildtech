...
export default {
  ...
  methods: {
    ...
    updateUser(id){
        ...
        if(!this.isUpdateUserValid()){
            toastr.error('User Update Failed', 'Failed Alert', {timeOut: 5000});
            return;
        }
    ...
    isUpdateUserValid(){
        ...
        // if(this.form.originalData.roles[0].id == 1){
        //     if(!(this.user.role == 'SuperAdmin')){
        //         toastr.error('User Update Failed', 'Failed Alert', {timeOut: 5000});
        //         return false;
        //     }
        // }
        // else if(this.form.originalData.roles[0].id == 2){
        //     if(!(this.user.role == 'SuperAdmin')){
        //           toastr.error('User Update Failed', 'Failed Alert', {timeOut: 5000});
        //           return false;
        //       }
